<div class="wrap">
	...
	<form method="post" action="options.php">
		...
		<br>
		<textarea name="rad_options[message]" class="large-text code"><?php echo $values['message'] ?></textarea>

		<label>Special Sale Link:</label>
		<br>
		<input type="url" name="rad_options[link]" value="<?php echo $values['link'] ?>">
